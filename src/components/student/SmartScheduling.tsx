           ...
           <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm transition-all hover:shadow-md">
                ...
                <div className="aspect-video bg-gray-100 rounded-2xl mb-4 overflow-hidden relative group">
                  <img src="https://picsum.photos/seed/formal-attire/400/225" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all" alt="Dress code" referrerPolicy="no-referrer" />
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-4">
                 ...
                 <button 
                   onClick={async () => {
                      ...
                      const doc = new jsPDF();
                      doc.text("ADNU SENIOR HIGH SCHOOL - YEARBOOK SHOOT CHECKLIST", 10, 10);
                      doc.text("1. Confirm Time Slot", 10, 20);
                      doc.text("2. Wear Proper Formal Uniform", 10, 30);
                      doc.text("3. Grooming Standards:", 10, 40);
                      doc.text("- Hair should be neatly combed", 15, 50);
                      doc.text("- No eccentric hair colors", 15, 60);
                      doc.text("- Proper hygiene maintained", 15, 70);
                      doc.text("4. Blazer must be clean and pressed", 10, 80);
                      doc.text("5. ADNU ID must be presented if required", 10, 90);
