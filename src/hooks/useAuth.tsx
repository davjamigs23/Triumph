...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // ... (onAuthStateChanged implementation remains similar, but need to handle user object being filled
  // NOTE: When using email/password, the firebaseUser object is less populated than Google)
